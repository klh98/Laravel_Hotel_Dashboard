...
<head>
    ...
    <title>Laravel Hotel App</title>

    @if(!Session::has('adminData'))
        <script>
            window.location.href= "{{ url('admin/adminAuth/login') }}"
        </script>
    @endif
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Novotel <sup>Hotel</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse @if(request()->is ('admin/roomtype*')) show collapsed @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Room Type Info:</h6>
            ...
            <li class="nav-item">
                ...
                <div id="RoomMaster" class="collapse @if(request()->is ('admin/rooms*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Room Info:</h6>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/adminAuth/logout') }}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ url('admin/adminAuth/logout') }}" data-toggle="modal" data-target="#logoutModal">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Kyaung Lan Htan</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
